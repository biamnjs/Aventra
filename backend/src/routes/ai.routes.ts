...
import { validate, chatSchema, idParamSchema } from '../middleware/validation.middleware';
...
router.post('/playlist/:id/refresh', validate(idParamSchema, 'params'), aiController.refreshPlaylist);
